...
class UserV1(SQLModel, table=True):
    ...
    id: Optional[str] = Field(default=None, sa_column=Column('id', String(32), primary_key=True))
    nikename: Optional[str] = Field(default=None, sa_column=Column('nikename', String(64)))
    ...
    long_nick: Optional[str] = Field(default=None, sa_column=Column('long_nick', String(255)))
